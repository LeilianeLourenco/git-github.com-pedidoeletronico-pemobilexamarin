...
{
    public class BuscaPrecoRepresentacaoManualRepositorio : IBuscaPrecoRepositorio
    {
        int _idProduto;
        public BuscaPrecoRepresentacaoManualRepositorio(int idProduto)
        {
...
join {TableMobile.TB_TABELAPRECO_REPRESENTACOES} tra on t.idTabelaPreco = tra.idTabelaPreco
and t.stValor == 2 and t.stAtivo = 1
and t.stTabelaPrecoRepresentacao = 1
