...
{
    public class BuscaPrecoRepresentanteManualRepository : IBuscaPrecoRepositorio
    {
        int _idProduto;
        public BuscaPrecoRepresentanteManualRepository(int idProduto)
        {
...
join {TableMobile.TB_TABELA_PRECO_REPRESENTANTES} tre on t.idTabelaPreco = tre.idTabelaPreco
...
and tre.idEmpresa_aspnetUsers = {id}";
