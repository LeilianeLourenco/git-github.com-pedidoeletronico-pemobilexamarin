...
{
    public class BuscaPrecoClienteManualRepositorio: IBuscaPrecoRepositorio
    {
        int _idProduto;
        public BuscaPrecoClienteManualRepositorio(int idProduto)
        {
...
join tb_tabela_preco_clientes tc on t.idTabelaPreco = tc.idTabelaPreco
