...
{
    public partial class PageDescontoPedido : PopupPage
    {
        public PageDescontoPedido(PedidoNewViewModel _viewModel)
        {
            InitializeComponent();
            ...
            EntryvDescontoPed.Completed += (sender, e) => { btnVoltar.Focus(); }; 
        }
        ...
        { 
            if(EntryvDescontoPed.Text != "0,00")
            { 
                btnVoltar.Text = "Rateando desconto...";
                viewmodel.RateiaDescontoTotalPedido();
            }
