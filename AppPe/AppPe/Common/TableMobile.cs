...
namespace Xamarin.HLP.Mobile.AppPE.Common
{
    public class TableMobile
    {
        ...
        public const string TB_REGRAS_COMERCIAIS_CRITERIOS_CONDICAOPAGAMENTO = "TB_REGRAS_COMERCIAIS_CRITERIOS_CONDICAOPAGAMENTO";
        public const string TB_REGRAS_COMERCIAIS_CRITERIOS_RAMOATIVIDADES = "TB_REGRAS_COMERCIAIS_CRITERIOS_RAMOATIVIDADES";
        public const string TB_REGRAS_COMERCIAIS_CRITERIOS_UF = "TB_REGRAS_COMERCIAIS_CRITERIOS_UF";
        public const string TB_REGRAS_COMERCIAIS_CRITERIOS_REPRESENTADAS = "TB_REGRAS_COMERCIAIS_CRITERIOS_REPRESENTADAS";
        public const string TB_REGRAS_COMERCIAIS_CRITERIOS_TABELAPRECO = "TB_REGRAS_COMERCIAIS_CRITERIOS_TABELAPRECO";
